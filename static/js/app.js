      ...
      caches.match(url).then(function(response) {
        if (response) {
		 ...
		 for(var i = 0, l = json.length; i < l; i++) {
			html = html + "<tr><td>" + json[i].departureSation.stationCode + "</td><td>" + json[i].arrivalStation.stationCode + "</td><td>" + json[i].departureDate + "</td><td>" + json[i].departureTime + "</td><td>" + json[i].price.currency + " " + json[i].price.price + "</td><td> <a  id=\"bookButton\" class=\"waves-effect waves-light btn\">Book</a></td>";
		 }
